...
export const OBJECTS = [
  ...
  { name: 'Boeing 737', shape: 'boeing737', length: 39.47, width: 35.79, height: 12.55, fuselageDiameter: 3.76, color: '#f6f8fb', x: 0, z: -180 },
...
export const MOBILE_INITIAL_CAMERA_POSITION = new THREE.Vector3(-24, 13, 22);
